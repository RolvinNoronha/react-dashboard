...
const Form = () => {
    ...
    return (
    <div className="justify-center flex-col items-center h-1/2 w-2/5">
        ...
        <div className="bg-white p-4 rounded-xl flex flex-col w-full">
            <label className="mb-2" htmlFor="email">Email Address</label>
            <input className="bg-slate-300 mb-4 rounded-lg p-2 focus:outline-none" type="text" id="email" />
            <label className="mb-2" htmlFor="password">Password</label>
            <input className="bg-slate-300 mb-2 rounded-lg p-2 focus:outline-none" type="password" id="password" />
            <p className="text-blue-400 mb-2">Forgot Password?</p>
            <button className="w-full py-2 rounded-lg mb-2 bg-black hover:bg-slate-600 transition-all duration-200 ease-in text-white">Sign In</button>
            <p className="mx-auto">Already have an account? <a className="text-blue-400" href="#">Register here</a></p>
        </div>
    </div>
  )
}
